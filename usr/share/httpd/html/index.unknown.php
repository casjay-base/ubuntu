...
<html>
  ...
  <body>
    ...
    <div class="c5">
      <br />
      <?php echo "Server Name: " . $_SERVER['SERVER_NAME'] . "<BR>"; echo "IP
      Address: " . $_SERVER['SERVER_ADDR'] . "<BR />"; ?> <br /><br />
      Linux OsVer:
      <?php echo shell_exec('cat /etc/casjaysdev/updates/versions/osversion.txt'); ?><br />
      ConfigVer:
